...
const namePrefix = "Weird Alien Pixel Club";
const description = "Weird Alien Pixel Club is an NFT collection created by twenty-year-old programmer from Nepal. It was created by using different layers and was generated programmatically using an open-source script.";
...
const CONTRACT_NAME = 'Weird Alien Pixel Club';
const CONTRACT_SYMBOL = 'WAPC';
...
const ROYALTY_ADDRESS = "0x41feB2D9065cBFaC8f9d9b55FE9f38B59164678d"; // Address that will receive the royalty
...
const PRESALE_WHITELISTED_ADDRESSES = [
  ...
  "0xC14aC42C1673C038a84f356bd2A47C295b345fF4"
